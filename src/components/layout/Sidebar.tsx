...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Тех. карты', href: '/manufacturing/tech-maps', icon: <FileText className="h-4 w-4" /> },
      { label: 'Тех. операции', href: '/manufacturing/tech-operations', icon: <ClipboardCheck className="h-4 w-4" /> },
    ],
  },
  {
    title: 'CRM',
